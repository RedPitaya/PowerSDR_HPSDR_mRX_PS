...
namespace PowerSDR
{
    ...
    public partial class Setup : Form
    {
        ...
        private void RefreshSkinList()
        {
            ...
            // Changed the path variable for the skins,
        ...
        private void radGenModelCharly25_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            if (radGenModelCharly25.Checked)  // Charly 25 is selected
            {
                ...
                */
                ...
                chkPennyLane.Checked = true;  // Charly 25 must behave like a Hermes
                chkMercuryPresent.Checked = false;  // Charly 25 doesn't need this functionality
                chkJanusPresent.Checked = false;  // Charly 25 doesn't have this functionality
                chkExcaliburPresent.Checked = false;  // Charly 25 doesn't have this functionality
                chkAlexPresent.Checked = false;  // Charly 25 doesn't have this functionality
                chkApolloPresent.Checked = false;  // Charly 25 doesn't have this functionality
                groupBox10MhzClock.Visible = false;  // Charly 25 must behave like a Hermes
                groupBox122MHz.Visible = false;  // Charly 25 must behave like a Hermes
                groupBoxMicSource.Visible = false;  // Charly 25 must behave like a Hermes
                chkHermesStepAttenuator.Checked = false;  // Charly 25 doesn't have this functionality
                grpHermesStepAttenuator.Visible = false;  // Charly 25 doesn't have this functionality
                groupBoxRXOptions.Text = "Mercury Options";
