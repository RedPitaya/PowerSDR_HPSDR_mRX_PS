...
set panelfilter=panelFilter.png
...
copy %panelfilter% %skinpath%panelFilter.png
...
copy %up1% %skinpath%chkPLTone-0.png
copy %up1% %skinpath%chkShowTXFilter-0.png
copy %up1% %skinpath%chkMicMute-0.png
...
copy %dn1% %skinpath%chkPLTone-1.png
copy %dn1% %skinpath%chkShowTXFilter-1.png
copy %dn1% %skinpath%chkMicMute-1.png
